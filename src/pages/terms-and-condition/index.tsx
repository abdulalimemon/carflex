...
const TermsAndConditions = () => {
  return (
    <>
      <section className="bg-gradient-to-r from-slate-50 to-to-gray-100 dark:from-gray-800 dark:to-zinc-900">
        <div className="flex justify-center items-center py-10 privacyAndTermsBg">
          <h2 className="font-bold text-white text-4xl md:text-8xl">
            Legal matters
          </h2>
        </div>
        <Container>
          <div>
            ...
            <p className="text-sm py-3">
              This Terms and Conditions describes Our policies and procedures on the
            ...
            <ul className="list-disc text-sm px-5 md:px-10">
              ...
              <li>
                <p className="text-sm py-1">
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to Car Flex, Dhaka,
                  Bangladesh.
                </p>
              </li>
              <li>
              ...
              <li>
                <p className="text-sm py-1">
                  <strong>Website</strong> refers to Car Flex, accessible from{" "}
                  <Link to="/" rel="external nofollow noopener" target="_blank">
                    https://car-flex.netlify.app/
                  </Link>
                </p>
              </li>
              <li>
            ...
            <ul className="list-disc text-sm px-5 md:px-10">
              ...
              <li>
                <p className="text-sm py-1">First name and last name</p>
              </li>
              <li>
                <p className="text-sm py-1">Phone number</p>
              </li>
              <li>
                <p className="text-sm py-1">
              ...
              <li>
                <p className="text-sm py-1">Usage Data</p>
              </li>
            </ul>
            <h4 className="text-xl font-semibold my-3">Usage Data</h4>
            <p className="text-sm pb-3">
            ...
            <ul className="list-disc text-sm px-5 md:px-10">
              <li>
                ...
                <p className="text-sm py-1">Type: Session Cookies</p>
                <p className="text-sm py-1">Administered by: Us</p>
                <p className="text-sm py-1">
              ...
              <li>
                ...
                <p className="text-sm py-1">Type: Persistent Cookies</p>
                <p className="text-sm py-1">Administered by: Us</p>
                <p className="text-sm py-1">
            ...
            <ul className="list-disc text-sm px-5 md:px-10 space-y-3">
              ...
              <li>
                ...
                affiliates to honor this Terms and Conditions. Affiliates include Our
            ...
            <p className="text-sm py-3">
              ...
              necessary for the purposes set out in this Terms and Conditions. We will
            ...
            <p className="text-sm py-3">
              Your consent to this Terms and Conditions followed by Your submission of
              such information represents Your agreement to that transfer.
            </p>
            <p className="text-sm py-3">
              The Company will take all steps reasonably necessary to ensure
              that Your data is treated securely and in accordance with this
              Terms and Conditions and no transfer of Your Personal Data will take
            ...
            <ul className="list-disc text-sm px-5 md:px-10 space-y-2">
            ...
            <h2 className="text-2xl font-semibold pt-5">Contact Us</h2>
            <p className="text-sm py-3">
            ...
            <ul className="list-disc text-sm px-5 md:px-10 space-y-2 pb-20">
              <li>
                ...
                <a
                  href="https://car-flex.netlify.app/terms-and-conditions"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://car-flex.netlify.app/terms-and-conditions
                </a>
              </li>
            </ul>
          </div>
